...
RSpec.describe "User Signing Up" do
  scenario "successfully" do
    ...
    find(:css, "#business_sign_up_form textarea[id$='business_user_description']").set(user.description)
    ...
    find(:css, "#business_sign_up_form select[id$='business_user_country']").set("Nepal")
