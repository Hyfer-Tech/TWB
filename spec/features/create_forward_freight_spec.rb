...
RSpec.describe "User Signing Up" do
  scenario "successfully" do
    user = FactoryGirl.create(:forward_freight)
    ...
    fill_in "Zip/Postal Code", with: user.zip_postal_code
    # find("#forward_freight_zip_postal_code").set "focom"
    fill_in "Service rate", with: user.service_rates
