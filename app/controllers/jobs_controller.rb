class JobsController < ApplicationController
	...
	def jobs_params
		params.require(:job).permit(:job_title,
																...
																:shipment_id,
																:date_of_shipment,
																:location_of_shipment,
																:place_being_shipped_to,
																:border_expected_to_cross,
																:price,
																:fta_tt,
																:insured,
																:type_of_job,
																:canada_cost_invoice,
																:free_trade_certificate,
																:form_A,
																:bill_of_lading,
																:tag_list => []).merge(client_id: current_user.id, client_type: current_user.class.name, shipment_id: params[:shipment_id])
	end
